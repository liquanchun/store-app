...
@Component({
  ...
  providers: [OrgService, StoreinService, StoreoutService],
})
export class Dashboard implements OnInit {
  ...
  constructor(private _router: Router,
    ...
    private _storeoutService: StoreoutService
  ) {
  ...
  ngOnInit() {
    ...
    this.getStoreOutMonth();
  }
  getStoreInList(): void {
    this._storeinService.getStoreinsByOrg().then((data) => {
      this.StoreInOption1 = Object.assign({}, this.StoreInOption1);
      this.StoreInOption1.series[0].data = data;
      this.StoreInOption1.series[0].color = _.take(this.colorList, data.length);
    })
  }
  getStoreOutList(): void {
    this._storeoutService.getStoreinsByOrg().then((data) => {
      this.StoreOutOption1 = Object.assign({}, this.StoreOutOption1);
      this.StoreOutOption1.series[0].data = data;
      this.StoreOutOption1.series[0].color = _.take(this.colorList, data.length);
    })
  }
  ...
  getStoreOutMonth(): void {
    this._storeoutService.getStoreinsByMonth().then((data) => {
      this.StoreOutOptionmonth = Object.assign({}, this.StoreOutOptionmonth);
      const keys = _.keys(data);
      this.StoreOutOptionmonth.legend.data = keys;
      this.StoreOutOptionmonth.color = _.take(this.colorList, keys.length);
      this.StoreOutOptionmonth.xAxis.data = _.keys(data[keys[0]]);
      ...
      this.StoreOutOptionmonth.series = series;
    })
  }
}
